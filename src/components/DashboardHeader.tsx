...
export default function DashboardHeader() {
  ...
  if (!user) {
    return <header className="bg-white shadow-sm border-b border-gray-200 px-6 py-4 h-[89px]"></header>;
  }
  ...
  return (
    <header className="bg-white shadow-sm border-b border-gray-200 px-6 py-4">
      <div className="flex items-center justify-between">
        {/* Tiêu đề Trái */}
        <div>
          <h1 className="text-2xl font-bold text-gray-900">{roleConfig.roleName} Dashboard</h1>
          <p className="text-sm text-gray-500 mt-1">Chào mừng trở lại, {displayName}</p>
        </div>
